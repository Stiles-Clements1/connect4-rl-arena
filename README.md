...
| Tournament | Live-match clickable UI — MCTS+SAC agent, you click columns to record opponent moves | ✓ | [`notebooks/tournament_play.ipynb`](notebooks/tournament_play.ipynb) [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Stiles-Clements1/connect4-rl-arena/blob/main/notebooks/tournament_play.ipynb) |
